...
const StreamMessenger = require('../../../src/components/streaming/StreamMessenger').default;

const mockLocalSend = jest.fn();
const mockOKASSend = jest.fn();

// Inject mocks into the actual modules used by StreamMessenger
const LocalStreamModule = require('../../../src/components/streaming/LocalStream/LocalStream');
if (LocalStreamModule && LocalStreamModule.default) {
  LocalStreamModule.default.sendMessage = mockLocalSend;
}

const OKASModule = require('../../../src/components/streaming/OKASStream/OKASStream');
