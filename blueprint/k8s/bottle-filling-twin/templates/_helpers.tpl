...
{{- define "bottle-filling-twin.pvc.contentStored" -}}
{{- if .Values.storage.contentStored.existingClaim }}
{{- .Values.storage.contentStored.existingClaim }}
{{- else }}
{{- printf "bottle-filling-twin-content-stored" }}
{{- end }}
{{- end }}
...
{{- else }}
{{- printf "bottle-filling-twin-shader-cache" }}
{{- end }}
{{- end }}
